  ...
  return (
    <div className="relative">
      <Carousel className="w-full" opts={{ align: "start", loop: true }}>
        ...
        <CarouselPrevious className="left-4 bg-background/80 hover:bg-background border-border hover:border-primary" />
        <CarouselNext className="right-4 bg-background/80 hover:bg-background border-border hover:border-primary" />
      </Carousel>
    </div>
  );
};